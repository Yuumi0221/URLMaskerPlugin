...
*based on [HelloPlugin](https://github.com/RockChinQ/hello_plugin) template*
...
```
!plugin get https://github.com/Yuumi0221/URLMaskerPlugin.git
```
...
安装完成后，机器人返回的url将被打码。如：百度的链接是`[https冒号//www点baidu点com](https冒号//www点baidu点com)`。